...
export const mockPedidos: Pedido[] = [
  {
    ...
    numero_orcamento: 'ORC-2026-089',
    transportadora: 'Jadlog',
    condicao_pagamento: '30/60 DDL',
    status_delta: 'aguardando',
    data_faturamento_prevista: new Date(Date.now() + 3 * 86400000).toISOString().split('T')[0],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    clientes: mockClientes[0],
  },
  {
    ...
    lembrete_faturamento_enviado: false,
    numero_orcamento: 'ORC-2026-091',
    transportadora: 'Correios PAC',
    condicao_pagamento: '28 DDL',
    status_delta: 'confirmado',
    data_faturamento_prevista: new Date(Date.now() + 6 * 86400000).toISOString().split('T')[0],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    clientes: mockClientes[1],
  },
  {
    ...
    cliente_id: '3',
    numero: 'PED-2026-003',
    data_pedido: new Date(Date.now() - 10 * 86400000).toISOString().split('T')[0],
    valor_total: 2800.0,
    status: 'faturado',
    data_faturamento: new Date(Date.now() - 2 * 86400000).toISOString().split('T')[0],
    lembrete_faturamento_enviado: true,
    numero_orcamento: 'ORC-2026-078',
    transportadora: 'TNT',
    condicao_pagamento: '30 DDL',
    status_delta: 'faturado',
    numero_nf: '000456',
    data_faturamento_prevista: new Date(Date.now() - 3 * 86400000).toISOString().split('T')[0],
    data_faturamento_real: new Date(Date.now() - 2 * 86400000).toISOString().split('T')[0],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    clientes: mockClientes[2],
  },
  {
    ...
    status: 'pendente',
    lembrete_faturamento_enviado: false,
    numero_orcamento: 'ORC-2026-095',
    condicao_pagamento: '60/90 DDL',
    status_delta: 'aguardando',
    data_faturamento_prevista: new Date(Date.now() + 10 * 86400000).toISOString().split('T')[0],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    clientes: mockClientes[0],
  },
  {
    ...
    cliente_id: '2',
    numero: 'PED-2026-005',
    data_pedido: new Date(Date.now() - 8 * 86400000).toISOString().split('T')[0],
    valor_total: 5900.0,
    status: 'aprovado',
    data_entrega_prevista: new Date(Date.now() - 1 * 86400000).toISOString().split('T')[0],
    lembrete_faturamento_enviado: true,
    numero_orcamento: 'ORC-2026-082',
    transportadora: 'Braspress',
    condicao_pagamento: '30 DDL',
    status_delta: 'atrasado',
    data_faturamento_prevista: new Date(Date.now() - 2 * 86400000).toISOString().split('T')[0],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    clientes: mockClientes[1],
  },
